...
namespace eval ttk::theme::forest-dark {
    ...
    ttk::style theme create forest-dark -parent default -settings {
        ...
        # Progressbar
        ttk::style element create Horizontal.Progressbar.trough image $I(hor-basic-black) \
            -sticky ew

        ttk::style element create Horizontal.Progressbar.pbar image $I(hor-accent-white) \
            -sticky ew
